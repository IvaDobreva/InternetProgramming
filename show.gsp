			...
			<ol class="property-list movies">
				...
				<li class="fieldcontain">
					<span id="cover-label" class="property-label"><g:message code="movies.coverImage.label" default="Cover" /></span>
						...
						<span class="property-value" aria-labelledby="cover-label"><g:fieldValue bean="${moviesInstance}" field="coverImagePath"/></span>
					
				</li>
				</g:if>
				<g:if test="${moviesInstance?.coverImagePath}">
					<li class="fieldcontain">
						 <img src="${resource(dir:'images/covers/', file: moviesInstance.fileName)}" alt="Grails"/>
					</li>
				</g:if>
